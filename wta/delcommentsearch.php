...
<div class="col3">
    <select name="commentcat" id="commentcat" style="width:5cm;height:1cm;" > 
    <option value="none" selected disabled hidden> 
          Select a comment
      </option>
	<option value = "comment1">comment1  
	</option>  
	<option value = "comment2"> comment2   
	</option>  
	<option value = "comment3"> comment3  
	</option>  
	<option value = "comment4"> comment4  
    </option> 
    <option value = "comment5"> comment5  
    </option>  
    <option value = "comment6"> comment6  
    </option>
    <option value = "comment7"> comment7  
    </option>
    <option value = "comment8"> comment8  
    </option>
    <option value = "comment9"> comment9  
    </option>
    <option value = "comment10"> comment10  
	</option>
    </select>  
    </div>
    </div>
<br>
<div class="row">
<div class="col" style="margin-left:16cm;">
