...
$sql = "SELECT * FROM educational ORDER BY id DESC LIMIT 10";
...
$id = $data[2]['id'];
$headlines = $data[2]['headlines'];
$content = $data[2] ['content'] ;
$authour = $data[2]['authour'];
$time = $data[2]['posttime'];
$conn->close();
...
if ($data[2]['comment1'] == NULL)
{
    $c1 = "comment1";
    $message = "Be the first one to comment!";
}
elseif($data[2]['comment2']==NULL){
    $c1 = "comment2";
}
elseif($data[2]['comment3']==NULL){
    $c1 = "comment3";
}
elseif($data[2]['comment4']==NULL){
    $c1 = "comment4";
}
elseif($data[2]['comment5']==NULL){
    $c1 = "comment5";
}
elseif($data[2]['comment6']==NULL){
    $c1 = "comment6";
}
elseif($data[2]['comment7']==NULL){
    $c1 = "comment7";
}
elseif($data[2]['comment8']==NULL){
    $c1 = "comment8";
}
elseif($data[2]['comment9']==NULL){
    $c1 = "comment9";
}
else {
    $c1 = "comment10";
...
<div class="row">
    ...
    <?php
echo '<img src="data:image;base64,'.base64_encode($data[2]['imag']).'" alt="image">';
?>
...
<?php
            if(isset($_SESSION['username'])) {
                ?>
                <br>    <form action="commentinsert.php" method="post">
...
<a href="educational2.php"><button type="submit" class="btn btn-primary" style="width:2.5cm;">Previous</button>
            </a></div>
<div class="offset-8 col-1">
<a href="educational4.php"><button class="btn btn-primary" style="width:2.5cm;">Next</button></a> 
</div>
</div>
</div>
<br><br>
