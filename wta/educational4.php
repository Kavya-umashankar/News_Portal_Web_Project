...
$id = $data[3]['id'];
$headlines = $data[3]['headlines'];
$content = $data[3] ['content'] ;
$authour = $data[3]['authour'];
$time = $data[3]['posttime'];
$conn->close();
...
if ($data[3]['comment1'] == NULL)
{
    $c1 = "comment1";
    $message = "Be the first one to comment!";
}
elseif($data[3]['comment2']==NULL){
    $c1 = "comment2";
}
elseif($data[3]['comment3']==NULL){
    $c1 = "comment3";
}
elseif($data[3]['comment4']==NULL){
    $c1 = "comment4";
}
elseif($data[3]['comment5']==NULL){
    $c1 = "comment5";
}
elseif($data[3]['comment6']==NULL){
    $c1 = "comment6";
}
elseif($data[3]['comment7']==NULL){
    $c1 = "comment7";
}
elseif($data[3]['comment8']==NULL){
    $c1 = "comment8";
}
elseif($data[3]['comment9']==NULL){
    $c1 = "comment9";
}
else {
    $c1 = "comment10";
...
<div class="row">
    ...
    <?php
echo '<img src="data:image;base64,'.base64_encode($data[3]['imag']).'" alt="image">';
?>
</div>
...
<a href="educational3.php"><button type="submit" class="btn btn-primary" style="width:2.5cm;">Previous</button>
            </a></div>
<div class="offset-8 col-1">
<a href="educational5.php"><button class="btn btn-primary" style="width:2.5cm;">Next</button></a> 
</div>
</div>
</div>
<br><br>
