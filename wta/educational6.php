...
$id = $data[5]['id'];
$headlines = $data[5]['headlines'];
$content = $data[5] ['content'] ;
$authour = $data[5]['authour'];
$time = $data[5]['posttime'];
$conn->close();
...
if ($data[5]['comment1'] == NULL)
{
    $c1 = "comment1";
    $message = "Be the first one to comment!";
}
elseif($data[5]['comment2']==NULL){
    $c1 = "comment2";
}
elseif($data[5]['comment3']==NULL){
    $c1 = "comment3";
}
elseif($data[5]['comment4']==NULL){
    $c1 = "comment4";
}
elseif($data[5]['comment5']==NULL){
    $c1 = "comment5";
}
elseif($data[5]['comment6']==NULL){
    $c1 = "comment6";
}
elseif($data[5]['comment7']==NULL){
    $c1 = "comment7";
}
elseif($data[5]['comment8']==NULL){
    $c1 = "comment8";
}
elseif($data[5]['comment9']==NULL){
    $c1 = "comment9";
}
else {
    $c1 = "comment10";
    ...
    <nav id="nav" class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item" style="color:white;"s>
...
<div class="row">
    ...
    <?php
echo '<img src="data:image;base64,'.base64_encode($data[5]['imag']).'" alt="image">';
?>
</div>
...
<a href="educational5.php"><button type="submit" class="btn btn-primary" style="width:2.5cm;">Previous</button>
            </a></div>
<div class="offset-8 col-1">
<a href="educational7.php"><button class="btn btn-primary" style="width:2.5cm;">Next</button></a> 
</div>
</div>
</div>
<br><br>
