...
$sql = "SELECT * FROM sports ORDER BY id DESC LIMIT 10";
...
$tablename="sports";
$id = $data[1]['id'];
$headlines = $data[1]['headlines'];
$content = $data[1] ['content'] ;
$authour = $data[1]['authour'];
$time = $data[1]['posttime'];
$conn->close();
...
if ($data[1]['comment1'] == NULL)
{
    $c1 = "comment1";
    $message = "Be the first one to comment!";
}
elseif($data[1]['comment2']==NULL){
    $c1 = "comment2";
}
elseif($data[1]['comment3']==NULL){
    $c1 = "comment3";
}
elseif($data[1]['comment4']==NULL){
    $c1 = "comment4";
}
elseif($data[1]['comment5']==NULL){
    $c1 = "comment5";
}
elseif($data[1]['comment6']==NULL){
    $c1 = "comment6";
}
elseif($data[1]['comment7']==NULL){
    $c1 = "comment7";
}
elseif($data[1]['comment8']==NULL){
    $c1 = "comment8";
}
elseif($data[1]['comment9']==NULL){
    $c1 = "comment9";
}
else {
    $c1 = "comment10";
...
<div class="row">
    ...
    <?php
echo '<img src="data:image;base64,'.base64_encode($data[1]['imag']).'" alt="image">';
?>
</div>
...
<a href="sports1.php"><button type="submit" class="btn btn-primary" style="width:2.5cm;">Previous</button>
            </a></div>
<div class="offset-8 col-1">
<a href="sports3.php"><button class="btn btn-primary" style="width:2.5cm;">Next</button></a> 
</div>
</div>
</div>
<br><br>
