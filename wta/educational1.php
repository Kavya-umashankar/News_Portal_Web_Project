...
if ($data[0]['comment1'] == NULL)
{
    $c1 = "comment1";
    $message = "Be the first one to comment!";
}
elseif($data[0]['comment2']==NULL){
    $c1 = "comment2";
}
elseif($data[0]['comment3']==NULL){
    $c1 = "comment3";
}
elseif($data[0]['comment4']==NULL){
    $c1 = "comment4";
}
elseif($data[0]['comment5']==NULL){
    $c1 = "comment5";
}
elseif($data[0]['comment6']==NULL){
    $c1 = "comment6";
}
elseif($data[0]['comment7']==NULL){
    $c1 = "comment7";
}
elseif($data[0]['comment8']==NULL){
    $c1 = "comment8";
}
elseif($data[0]['comment9']==NULL){
    $c1 = "comment9";
}
else {
    $c1 = "comment10";
...
<div class="row">
    ...
    <?php
echo '<img src="data:image;base64,'.base64_encode($data[0]['imag']).'" alt="image">';
?>
...
<a href="educational2.php"><button class="btn btn-primary" style="width:2.5cm;">Next</button></a> 
</div>
</div>
</div>
<br><br>
