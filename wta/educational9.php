...
$id = $data[8]['id'];
$headlines = $data[8]['headlines'];
$content = $data[8] ['content'] ;
$authour = $data[8]['authour'];
$time = $data[8]['posttime'];
$conn->close();
...
if ($data[8]['comment1'] == NULL)
{
    $c1 = "comment1";
    $message = "Be the first one to comment!";
}
elseif($data[8]['comment2']==NULL){
    $c1 = "comment2";
}
elseif($data[8]['comment3']==NULL){
    $c1 = "comment3";
}
elseif($data[8]['comment4']==NULL){
    $c1 = "comment4";
}
elseif($data[8]['comment5']==NULL){
    $c1 = "comment5";
}
elseif($data[8]['comment6']==NULL){
    $c1 = "comment6";
}
elseif($data[8]['comment7']==NULL){
    $c1 = "comment7";
}
elseif($data[8]['comment8']==NULL){
    $c1 = "comment8";
}
elseif($data[8]['comment9']==NULL){
    $c1 = "comment9";
}
else {
    $c1 = "comment10";
...
<div class="row">
    ...
    <?php
echo '<img src="data:image;base64,'.base64_encode($data[8]['imag']).'" alt="image">';
?>
</div>
...
<a href="educational8.php"><button type="submit" class="btn btn-primary" style="width:2.5cm;">Previous</button>
            </a></div>
<div class="offset-8 col-1">
<a href="educational10.php"><button class="btn btn-primary" style="width:2.5cm;">Next</button></a> 
</div>
</div>
</div>
<br><br>
