...
<a href="national3.php"><button type="submit" class="btn btn-primary" style="width:2.5cm;">Previous</button>
            </a></div>
<div class="offset-8 col-1">
<a href="national5.php"><button class="btn btn-primary" style="width:2.5cm;">Next</button></a> 
</div>
</div>
</div>
<br><br>
