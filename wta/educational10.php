...
$id = $data[9]['id'];
$headlines = $data[9]['headlines'];
$content = $data[9] ['content'] ;
$authour = $data[9]['authour'];
$time = $data[9]['posttime'];
$conn->close();
...
if ($data[9]['comment1'] == NULL)
{
    $c1 = "comment1";
    $message = "Be the first one to comment!";
}
elseif($data[9]['comment2']==NULL){
    $c1 = "comment2";
}
elseif($data[9]['comment3']==NULL){
    $c1 = "comment3";
}
elseif($data[9]['comment4']==NULL){
    $c1 = "comment4";
}
elseif($data[9]['comment5']==NULL){
    $c1 = "comment5";
}
elseif($data[9]['comment6']==NULL){
    $c1 = "comment6";
}
elseif($data[9]['comment7']==NULL){
    $c1 = "comment7";
}
elseif($data[9]['comment8']==NULL){
    $c1 = "comment8";
}
elseif($data[9]['comment9']==NULL){
    $c1 = "comment9";
}
else {
    $c1 = "comment10";
...
<div class="row">
    ...
    <?php
echo '<img src="data:image;base64,'.base64_encode($data[9]['imag']).'" alt="image">';
?>
</div>
...
<a href="educational9.php"><button type="submit" class="btn btn-primary" style="width:2.5cm;">Previous</button>
            </a></div>
<div class="offset-8 col-1">
<a href="search.php"><button class="btn btn-primary" style="width:2.5cm;">Search</button></a> 
</div>
</div>
</div>
<br><br>
